...
public class TeleOpBlue extends NextFTCOpMode {
    ...
    public void onStartButtonPressed() {
        ...
        // DPad Controls for Manual Shuffler Indexing Might be causing random movements
    ...
    it is also low-key a schizophreniac way of doing things but that's what I do best
    ( YOU SPELT SCHIZO WRONG ^ DURRRRRRRRRRRRRRRRRRR)
    */
