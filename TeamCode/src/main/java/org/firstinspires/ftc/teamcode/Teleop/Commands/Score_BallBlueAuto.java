...
public class Score_BallBlueAuto extends Command {
    ...
    public Score_BallBlueAuto(int slotIndex, double time) {
        ...
        this.sequence = new SequentialGroup(
                ...
                new ParallelGroup(
                        shooter.on(Vision.INSTANCE.getShooterPowerBlue()), // Start Flywheel
                        new Delay(time) // Wait 3 seconds for flywheel to stabilize
                ).requires(shooter),
